...
case 'helpme': {
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.helpme(botname, pushname, salam), `© ${ownername}`, [{"urlButton": {"displayText": "Tutorial Video 🎥","url": `${tiktok}`}},{"urlButton": {"displayText": "Instagram 🐸","url": `${ig}`}},{"urlButton": {"displayText": "CS Live Chat 🎧","url": `${cslive}`}}}] )
}
}
break
case 'statbot': {
