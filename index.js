...
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"quickReplyButton": {"displayText": "List Menu 📃","id": 'premrose'}},{"quickReplyButton": {"displayText": "Beli Premium 🌟","id": 'premrose'}},{"quickReplyButton": {"displayText": "Help & Bantuan ⁉️","id": 'premrose'}},{"quickReplyButton": {"displayText": "Status Bot ??️","id": 'statbot'}}] )
}
}
break
case 'premrose': {
