...
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"quickReplyButton": {"displayText": "List Menu 📃","id": 'listcommand'}}] )
}
}
break
case 'premrose': {
...
case 'listcommand': {
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.listcmd(botname, pushname, salam), `© ${ownername}`,rosejpg, [{"quickReplyButton": {"displayText": "Back List 🔙","id": 'menu'}},{"quickReplyButton": {"displayText": "Beli Premium 🌟","id": 'premrose'}},{"quickReplyButton": {"displayText": "Help & Bantuan ⁉️","id": 'premrose'}},{"quickReplyButton": {"displayText": "Status Bot 🖥️","id": 'statbot'}}] )
}
}
break
case 'helpme': {
